...
'''
#white_balance_1 : quickly
#white_balance_2 : spend more time
#white_balance_3 : spend more memory (killed)
#white_balance_4 : spend more time
#white_balance_5 : spend more time
'''
